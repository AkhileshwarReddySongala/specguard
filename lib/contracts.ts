...
export const compiledContractSchema = z.object({
  checks: z.array(compiledCheckSchema).max(30),
  unexpressibleRules: z.array(z.string()),
  compiler: z.literal("deterministic-fallback"),
});
...
export const prSnapshotSchema = z.object({
  ...
  changedFiles: z.array(changedFileSchema).max(25),
});
